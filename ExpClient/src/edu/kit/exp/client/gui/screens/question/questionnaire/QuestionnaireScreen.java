...
public class QuestionnaireScreen extends QuestionScreen {
	...
	private static final String TITLE_TEXT = "Questionnaire";
	private static final String PRE_TEXT = "Click the button to start the questionnaire.";
	private static final String POST_TEXT = "You completed the questionnaire. Click the button to continue the experiment.";
	private static final String WRONG_ANSWER_TEXT = "This value is not valid!";
	 ...
	 */
	public QuestionnaireScreen(String gameId, QuestionScreen.ParamObject parameter, String screenId, Long showUpTime) {
	...
	public void showNextQuestion() {
		...
		if (isLastQuestion && questionnaireIsValid) {
