 ...
 * @see Environment
 */
public class WebApiExperimentEnvironment extends Environment implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -7893037084477956473L;
	 ...
	 */
	public WebApiExperimentEnvironment() {
		super();
		this.roles.add("User");
