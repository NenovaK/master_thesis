 ...
 * @see Screen
 */
public class MobileOrderApiSwaggerUiFeelScreen extends Screen {
	...
	public MobileOrderApiSwaggerUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_swaggerui_feel + "&client_id=" + this.guiController.getClientId());	
