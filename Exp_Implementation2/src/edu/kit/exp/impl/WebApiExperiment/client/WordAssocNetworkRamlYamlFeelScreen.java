 ...
 * @see Screen
 */
public class WordAssocNetworkRamlYamlFeelScreen extends Screen {
	...
	public WordAssocNetworkRamlYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_ramlyaml_feel + "&client_id=" + this.guiController.getClientId());	
