 ...
 * @see Screen
 */
public class LufthansaAmfFeelScreen extends Screen {
	...
	private static final long serialVersionUID = -5532903241165693881L;
	...
	public LufthansaAmfFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_amf_feel + "&client_id=" + this.guiController.getClientId());	
