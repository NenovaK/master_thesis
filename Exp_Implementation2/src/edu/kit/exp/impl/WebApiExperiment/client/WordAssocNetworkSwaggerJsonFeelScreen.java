 ...
 * @see Screen
 */
public class WordAssocNetworkSwaggerJsonFeelScreen extends Screen {
	...
	public WordAssocNetworkSwaggerJsonFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_swaggerjson_feel + "&client_id=" + this.guiController.getClientId());	
