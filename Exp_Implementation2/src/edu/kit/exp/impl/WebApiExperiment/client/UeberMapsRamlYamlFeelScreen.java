 ...
 * @see Screen
 */
public class UeberMapsRamlYamlFeelScreen extends Screen {
	...
	public UeberMapsRamlYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_swaggerui_feel + "&client_id=" + this.guiController.getClientId());	
