 ...
 * @see Screen
 */
public class WorldMusicApiSwaggerJsonBrowserScreen extends Screen {
	...
	public WorldMusicApiSwaggerJsonBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_swaggerjson  + "?client_id=" + this.guiController.getClientId());	
