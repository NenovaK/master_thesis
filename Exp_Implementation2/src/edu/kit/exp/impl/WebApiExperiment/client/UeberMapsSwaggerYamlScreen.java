 ...
 * @see Screen
 */
public class UeberMapsSwaggerYamlScreen extends Screen {
	...
	public UeberMapsSwaggerYamlScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_swaggeryaml + "?client_id=" + this.guiController.getClientId());	
