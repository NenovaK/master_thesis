 ...
 * @see Screen
 */
public class MobileOrderApiSwaggerUiBrowserScreen extends Screen {
	...
	public MobileOrderApiSwaggerUiBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_swaggerui + "?client_id" + this.guiController.getClientId());	
