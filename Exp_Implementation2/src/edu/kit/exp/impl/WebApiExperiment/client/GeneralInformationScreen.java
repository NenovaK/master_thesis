 ...
 * @see Screen
 */
public class GeneralInformationScreen extends Screen {

	/** duration of the screen shown in milliseconds */
	private static final int DURATION_OF_SCREEN = 2*60*1000 + 2*1000;
	...
	public GeneralInformationScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.general_information + "?client_id=" + this.guiController.getClientId());	
