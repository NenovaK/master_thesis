 ...
 * @see Screen
 */
public class LufthansaSwaggerYamlFeelScreen extends Screen {
	...
	public LufthansaSwaggerYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_swaggeryaml_feel + "&client_id=" + this.guiController.getClientId());	
