 ...
 * @see Screen
 */
public class WorldMusicApiSwaggerJsonFeelScreen extends Screen {
	...
	public WorldMusicApiSwaggerJsonFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_swaggerjson_feel + "&client_id=" + this.guiController.getClientId());	
