 ...
 * @see Screen
 */
public class AifbRamlUiFeelScreen extends Screen {
	...
	public AifbRamlUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_ramlui_feel + "&client_id=" + this.guiController.getClientId());	
