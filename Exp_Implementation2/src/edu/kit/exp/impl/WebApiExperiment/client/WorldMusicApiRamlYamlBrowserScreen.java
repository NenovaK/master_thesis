 ...
 * @see Screen
 */
public class WorldMusicApiRamlYamlBrowserScreen extends Screen {
	...
	public WorldMusicApiRamlYamlBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_ramlyaml + "?client_id" + this.guiController.getClientId());	
