 ...
 * @see Screen
 */
public class AifbBlueprintFeelScreen extends Screen {
	...
	public AifbBlueprintFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_blueprint_feel + "&client_id=" + this.guiController.getClientId());	
