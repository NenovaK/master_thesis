 ...
 * @see Screen
 */
public class WorldMusicApiBlueprintBrowserScreen extends Screen {
	...
	public WorldMusicApiBlueprintBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_blueprint + "?client_id=" + this.guiController.getClientId());	
