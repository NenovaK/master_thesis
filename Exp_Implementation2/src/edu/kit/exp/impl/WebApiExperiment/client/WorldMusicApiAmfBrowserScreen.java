 ...
 * @see Screen
 */
public class WorldMusicApiAmfBrowserScreen extends Screen {
	...
	public WorldMusicApiAmfBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_amf + "?client_id" + this.guiController.getClientId());	
