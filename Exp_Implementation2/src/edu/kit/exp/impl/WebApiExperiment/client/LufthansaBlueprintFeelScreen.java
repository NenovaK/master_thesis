 ...
 * @see Screen
 */
public class LufthansaBlueprintFeelScreen extends Screen {
	...
	private static final long serialVersionUID = -5532903241165691234L;
	...
	public LufthansaBlueprintFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_blueprint_feel + "&client_id=" + this.guiController.getClientId());	
