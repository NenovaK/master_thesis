 ...
 * @see Screen
 */
public class AifbAmfBrowserScreen extends Screen {
	...
	public AifbAmfBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_amf + "?client_id" + this.guiController.getClientId());	
