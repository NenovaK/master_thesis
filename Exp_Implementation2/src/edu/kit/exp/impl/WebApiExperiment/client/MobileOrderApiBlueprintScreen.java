 ...
 * @see Screen
 */
public class MobileOrderApiBlueprintScreen extends Screen {
	...
	public MobileOrderApiBlueprintScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_blueprint + "?client_id=" + this.guiController.getClientId());	
