 ...
 * @see Screen
 */
public class UeberMapsAmfScreen extends Screen {
	...
	public UeberMapsAmfScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_amf + "?client_id" + this.guiController.getClientId());	
