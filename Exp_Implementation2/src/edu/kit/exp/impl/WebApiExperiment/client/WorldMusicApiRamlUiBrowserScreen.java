 ...
 * @see Screen
 */
public class WorldMusicApiRamlUiBrowserScreen extends Screen {
	...
	public WorldMusicApiRamlUiBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_ramlui + "?client_id" + this.guiController.getClientId());	
