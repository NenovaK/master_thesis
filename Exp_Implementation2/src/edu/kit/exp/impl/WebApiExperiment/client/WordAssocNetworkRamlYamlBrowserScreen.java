 ...
 * @see Screen
 */
public class WordAssocNetworkRamlYamlBrowserScreen extends Screen {
	...
	public WordAssocNetworkRamlYamlBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_ramlyaml + "?client_id=" + this.guiController.getClientId());	
