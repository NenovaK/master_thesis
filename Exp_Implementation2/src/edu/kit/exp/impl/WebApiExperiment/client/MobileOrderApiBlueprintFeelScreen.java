 ...
 * @see Screen
 */
public class MobileOrderApiBlueprintFeelScreen extends Screen {
	...
	public MobileOrderApiBlueprintFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_blueprint_feel + "&client_id=" + this.guiController.getClientId());	
