 ...
 * @see Screen
 */
public class WordAssocNetworkSwaggerYamlFeelScreen extends Screen {
	...
	public WordAssocNetworkSwaggerYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_swaggeryaml_feel + "&client_id=" + this.guiController.getClientId());	
