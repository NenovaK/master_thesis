 ...
 * @see Screen
 */
public class WordAssocNetworkBlueprintBrowserScreen extends Screen {
	...
	public WordAssocNetworkBlueprintBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_blueprint + "?client_id" + this.guiController.getClientId());	
