 ...
 * @see Screen
 */
public class AifbRamlYamlBrowserScreen extends Screen {
	...
	public AifbRamlYamlBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_ramlyaml + "?client_id" + this.guiController.getClientId());	
