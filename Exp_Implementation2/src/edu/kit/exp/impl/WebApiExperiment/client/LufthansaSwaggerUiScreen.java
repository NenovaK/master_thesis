package edu.kit.exp.impl.WebApiExperiment.client;
 ...
 * @see Screen
 */
public class LufthansaSwaggerUiScreen extends Screen {
	...
	public LufthansaSwaggerUiScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_swaggerui + "?client_id=" + this.guiController.getClientId());	
		System.out.println(ExperimentConfiguration.uebermaps_blueprint_feel + "&client_id=" + this.guiController.getClientId());
