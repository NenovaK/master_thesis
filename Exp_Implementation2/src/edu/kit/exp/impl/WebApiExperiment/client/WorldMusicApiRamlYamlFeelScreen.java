 ...
 * @see Screen
 */
public class WorldMusicApiRamlYamlFeelScreen extends Screen {
	...
	public WorldMusicApiRamlYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_ramlyaml_feel + "&client_id=" + this.guiController.getClientId());	
