 ...
 * @see Screen
 */
public class LufthansaRamlYamlFeelScreen extends Screen {
	...
	public LufthansaRamlYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_ramlyaml_feel + "&client_id=" + this.guiController.getClientId());	
