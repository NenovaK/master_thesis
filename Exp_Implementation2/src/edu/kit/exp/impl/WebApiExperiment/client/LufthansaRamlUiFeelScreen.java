 ...
 * @see Screen
 */
public class LufthansaRamlUiFeelScreen extends Screen {
	...
	public LufthansaRamlUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_ramlui_feel + "&client_id=" + this.guiController.getClientId());	
