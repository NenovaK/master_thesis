 ...
 * @see Screen
 */
public class LufthansaAmfScreen extends Screen {
	...
	public LufthansaAmfScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_amf + "?client_id=" + this.guiController.getClientId());	
