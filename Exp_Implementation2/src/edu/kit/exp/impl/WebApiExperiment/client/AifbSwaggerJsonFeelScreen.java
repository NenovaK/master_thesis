 ...
 * @see Screen
 */
public class AifbSwaggerJsonFeelScreen extends Screen {
	...
	public AifbSwaggerJsonFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_swaggerjson_feel + "&client_id=" + this.guiController.getClientId());	
