 ...
 * @see Screen
 */
public class MobileOrderApiSwaggerYamlBrowserScreen extends Screen {
	...
	public MobileOrderApiSwaggerYamlBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_swaggeryaml + "?client_id=" + this.guiController.getClientId());	
