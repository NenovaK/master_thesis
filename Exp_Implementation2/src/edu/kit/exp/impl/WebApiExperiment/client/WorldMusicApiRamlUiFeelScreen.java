 ...
 * @see Screen
 */
public class WorldMusicApiRamlUiFeelScreen extends Screen {
	...
	public WorldMusicApiRamlUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_ramlui_feel + "&client_id=" + this.guiController.getClientId());	
