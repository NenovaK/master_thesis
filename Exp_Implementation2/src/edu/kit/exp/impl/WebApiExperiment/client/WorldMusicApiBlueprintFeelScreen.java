 ...
 * @see Screen
 */
public class WorldMusicApiBlueprintFeelScreen extends Screen {
	...
	public WorldMusicApiBlueprintFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_blueprint_feel + "&client_id=" + this.guiController.getClientId());	
