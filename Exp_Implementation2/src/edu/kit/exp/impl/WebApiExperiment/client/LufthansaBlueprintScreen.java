 ...
 * @see Screen
 */
public class LufthansaBlueprintScreen extends Screen {
	...
	public LufthansaBlueprintScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_blueprint + "?client_id" + this.guiController.getClientId());	
