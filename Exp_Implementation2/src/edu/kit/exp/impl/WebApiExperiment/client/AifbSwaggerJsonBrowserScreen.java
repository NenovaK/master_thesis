 ...
 * @see Screen
 */
public class AifbSwaggerJsonBrowserScreen extends Screen {
	...
	public AifbSwaggerJsonBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_swaggerjson  + "?client_id=" + this.guiController.getClientId());	
