 ...
 * @see Screen
 */
public class LufthansaSwaggerUiFeelScreen extends Screen {
	...
	public LufthansaSwaggerUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_swaggerui_feel + "&client_id=" + this.guiController.getClientId());	
