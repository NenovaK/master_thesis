 ...
 * @see Screen
 */
public class MobileOrderApiRamlUiScreen extends Screen {
	...
	public MobileOrderApiRamlUiScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_ramlui + "?client_id" + this.guiController.getClientId());	
