 ...
 * @see Screen
 */
public class WordAssocNetworkSwaggerUiBrowserScreen extends Screen {
	...
	public WordAssocNetworkSwaggerUiBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_swaggerui + "?client_id=" + this.guiController.getClientId());	
