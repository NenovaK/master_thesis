 ...
 * @see Screen
 */
public class WorldMusicApiSwaggerYamlFeelScreen extends Screen {
	...
	public WorldMusicApiSwaggerYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_swaggeryaml_feel + "&client_id=" + this.guiController.getClientId());	
