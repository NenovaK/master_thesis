 ...
 * @see Screen
 */
public class WordAssocNetworkSwaggerUiFeelScreen extends Screen {
	...
	public WordAssocNetworkSwaggerUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_swaggerui_feel + "&client_id=" + this.guiController.getClientId());	
