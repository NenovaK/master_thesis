 ...
 * @see Screen
 */
public class LufthansaRamlYamlScreen extends Screen {
	...
	public LufthansaRamlYamlScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_ramlyaml + "?client_id=" + this.guiController.getClientId());	
