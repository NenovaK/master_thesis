 ...
 * @see Screen
 */
public class WorldMusicApiSwaggerYamlBrowserScreen extends Screen {
	...
	public WorldMusicApiSwaggerYamlBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_swaggeryaml + "?client_id" + this.guiController.getClientId());	
