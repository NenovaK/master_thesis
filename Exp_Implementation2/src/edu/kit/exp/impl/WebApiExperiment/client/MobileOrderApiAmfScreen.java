 ...
 * @see Screen
 */
public class MobileOrderApiAmfScreen extends Screen {
	...
	public MobileOrderApiAmfScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_amf + "?client_id" + this.guiController.getClientId());	
