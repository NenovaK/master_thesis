 ...
 * @see Screen
 */
public class WordAssocNetworkAmfBrowserScreen extends Screen {
	...
	public WordAssocNetworkAmfBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_amf + "?client_id" + this.guiController.getClientId());	
