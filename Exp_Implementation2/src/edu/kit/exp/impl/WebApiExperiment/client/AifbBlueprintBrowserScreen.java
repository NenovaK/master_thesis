 ...
 * @see Screen
 */
public class AifbBlueprintBrowserScreen extends Screen {
	...
	public AifbBlueprintBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_blueprint + "?client_id" + this.guiController.getClientId());	
