 ...
 * @see Screen
 */
public class WordAssocNetworkRamlUiFeelScreen extends Screen {
	...
	public WordAssocNetworkRamlUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_ramlui_feel + "&client_id=" + this.guiController.getClientId());	
