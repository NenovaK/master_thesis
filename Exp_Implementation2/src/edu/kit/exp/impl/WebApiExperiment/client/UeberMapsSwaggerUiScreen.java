 ...
 * @see Screen
 */
public class UeberMapsSwaggerUiScreen extends Screen {
	...
	public UeberMapsSwaggerUiScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_swaggerui + "?client_id=" + this.guiController.getClientId());	
