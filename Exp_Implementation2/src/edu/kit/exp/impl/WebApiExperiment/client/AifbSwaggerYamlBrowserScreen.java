 ...
 * @see Screen
 */
public class AifbSwaggerYamlBrowserScreen extends Screen {
	...
	public AifbSwaggerYamlBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_swaggeryaml + "?client_id=" + this.guiController.getClientId());	
