 ...
 * @see Screen
 */
public class UeberMapsRamlUiScreen extends Screen {
	...
	public UeberMapsRamlUiScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_ramlui + "?client_id=" + this.guiController.getClientId());	
