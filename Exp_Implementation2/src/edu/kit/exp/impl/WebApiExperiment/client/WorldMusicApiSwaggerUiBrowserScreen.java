 ...
 * @see Screen
 */
public class WorldMusicApiSwaggerUiBrowserScreen extends Screen {
	...
	public WorldMusicApiSwaggerUiBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_swaggerui + "?client_id" + this.guiController.getClientId());	
