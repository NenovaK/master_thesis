 ...
 * @see Screen
 */
public class AifbSwaggerUiFeelScreen extends Screen {
	...
	public AifbSwaggerUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_swaggerui_feel + "&client_id=" + this.guiController.getClientId());	
