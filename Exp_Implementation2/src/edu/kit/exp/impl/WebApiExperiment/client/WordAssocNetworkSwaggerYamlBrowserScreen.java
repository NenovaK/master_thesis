 ...
 * @see Screen
 */
public class WordAssocNetworkSwaggerYamlBrowserScreen extends Screen {
	...
	public WordAssocNetworkSwaggerYamlBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_swaggeryaml + "?client_id" + this.guiController.getClientId());	
