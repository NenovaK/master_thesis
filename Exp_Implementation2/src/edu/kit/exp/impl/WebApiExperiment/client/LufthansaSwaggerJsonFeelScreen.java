 ...
 * @see Screen
 */
public class LufthansaSwaggerJsonFeelScreen extends Screen {
	...
	public LufthansaSwaggerJsonFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_swaggerjson_feel + "&client_id=" + this.guiController.getClientId());	
