 ...
 * @see Screen
 */
public class MobileOrderApiSwaggerJsonBrowserScreen extends Screen {
	...
	public MobileOrderApiSwaggerJsonBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_swaggerjson + "?client_id" + this.guiController.getClientId());	
