 ...
 * @see Screen
 */
public class WorldMusicApiAmfFeelScreen extends Screen {
	...
	public WorldMusicApiAmfFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_amf_feel + "&client_id=" + this.guiController.getClientId());	
