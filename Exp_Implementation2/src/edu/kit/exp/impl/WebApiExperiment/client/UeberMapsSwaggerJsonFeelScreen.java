 ...
 * @see Screen
 */
public class UeberMapsSwaggerJsonFeelScreen extends Screen {
	...
	public UeberMapsSwaggerJsonFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_swaggerjson_feel + "&client_id=" + this.guiController.getClientId());	
