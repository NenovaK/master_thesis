 ...
 * @see Screen
 */
public class WordAssocNetworkBlueprintFeelScreen extends Screen {
	...
	public WordAssocNetworkBlueprintFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_blueprint_feel + "&client_id=" + this.guiController.getClientId());	
