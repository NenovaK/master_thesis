 ...
 * @see Screen
 */
public class AifbSwaggerUiBrowserScreen extends Screen {
	...
	public AifbSwaggerUiBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_swaggerui + "?client_id=" + this.guiController.getClientId());	
