 ...
 * @see Screen
 */
public class LufthansaSwaggerJsonScreen extends Screen {
	...
	public LufthansaSwaggerJsonScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_swaggerjson + "?client_id" + this.guiController.getClientId());	
