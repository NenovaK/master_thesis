 ...
 * @see Screen
 */
public class UeberMapsBlueprintScreen extends Screen {
	...
	public UeberMapsBlueprintScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_blueprint + "?client_id=" + this.guiController.getClientId());	
