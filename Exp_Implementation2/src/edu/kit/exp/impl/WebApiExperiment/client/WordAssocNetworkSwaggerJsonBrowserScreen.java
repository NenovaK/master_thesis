 ...
 * @see Screen
 */
public class WordAssocNetworkSwaggerJsonBrowserScreen extends Screen {
	...
	public WordAssocNetworkSwaggerJsonBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_swaggerjson + "?client_id" + this.guiController.getClientId());	
