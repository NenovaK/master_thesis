 ...
 * @see Screen
 */
public class MobileOrderApiAmfFeelScreen extends Screen {
	...
	public MobileOrderApiAmfFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_amf_feel + "&client_id=" + this.guiController.getClientId());	
