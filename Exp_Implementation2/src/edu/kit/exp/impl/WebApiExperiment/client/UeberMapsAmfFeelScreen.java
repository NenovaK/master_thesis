 ...
 * @see Screen
 */
public class UeberMapsAmfFeelScreen extends Screen {
	...
	public UeberMapsAmfFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_amf_feel + "&client_id=" + this.guiController.getClientId());	
