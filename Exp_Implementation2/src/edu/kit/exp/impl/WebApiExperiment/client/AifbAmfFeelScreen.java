 ...
 * @see Screen
 */
public class AifbAmfFeelScreen extends Screen {
	...
	public AifbAmfFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_amf_feel + "&client_id=" + this.guiController.getClientId());	
