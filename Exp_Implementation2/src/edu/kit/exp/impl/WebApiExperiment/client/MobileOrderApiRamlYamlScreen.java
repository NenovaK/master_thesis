 ...
 * @see Screen
 */
public class MobileOrderApiRamlYamlScreen extends Screen {
	...
	public MobileOrderApiRamlYamlScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_ramlyaml + "?client_id=" + this.guiController.getClientId());	
