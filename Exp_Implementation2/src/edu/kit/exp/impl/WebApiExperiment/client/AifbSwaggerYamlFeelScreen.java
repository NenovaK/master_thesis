 ...
 * @see Screen
 */
public class AifbSwaggerYamlFeelScreen extends Screen {
	...
	public AifbSwaggerYamlFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.aifb_swaggeryaml_feel + "&client_id=" + this.guiController.getClientId());	
