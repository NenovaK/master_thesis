 ...
 * @see Screen
 */
public class TroubleScreen extends Screen {

	/** duration of the screen shown in milliseconds */
	private static final int DURATION_OF_SCREEN = 5000;
	...
	public TroubleScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
