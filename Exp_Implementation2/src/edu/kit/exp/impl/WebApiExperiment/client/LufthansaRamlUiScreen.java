 ...
 * @see Screen
 */
public class LufthansaRamlUiScreen extends Screen {
	...
	public LufthansaRamlUiScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_ramlui + "?client_id=" + this.guiController.getClientId());	
