 ...
 * @see Screen
 */
public class WordAssocNetworkRamlUiBrowserScreen extends Screen {
	...
	public WordAssocNetworkRamlUiBrowserScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_ramlui + "?client_id" + this.guiController.getClientId());	
