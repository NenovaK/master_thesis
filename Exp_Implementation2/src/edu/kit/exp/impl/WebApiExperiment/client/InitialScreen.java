...
public class InitialScreen extends Screen {
	...
	private static final int DURATION_OF_SCREEN = ExperimentConfiguration.startduration;
	...
	public InitialScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.initial);	
