 ...
 * @see Screen
 */
public class LufthansaSwaggerYamlScreen extends Screen {
	...
	public LufthansaSwaggerYamlScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.lufthansa_swaggeryaml + "?client_id=" + this.guiController.getClientId());	
