 ...
 * @see Screen
 */
public class MobileOrderApiSwaggerJsonFeelScreen extends Screen {
	...
	public MobileOrderApiSwaggerJsonFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.mobileorderapi_swaggerjson_feel + "&client_id=" + this.guiController.getClientId());	
