 ...
 * @see Screen
 */
public class UeberMapsSwaggerJsonScreen extends Screen {
	...
	public UeberMapsSwaggerJsonScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.uebermaps_swaggerjson + "?client_id=" + this.guiController.getClientId());	
