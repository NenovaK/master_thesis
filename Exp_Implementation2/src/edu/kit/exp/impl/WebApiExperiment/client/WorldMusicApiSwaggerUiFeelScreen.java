 ...
 * @see Screen
 */
public class WorldMusicApiSwaggerUiFeelScreen extends Screen {
	...
	public WorldMusicApiSwaggerUiFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.worldmusicapi_swaggerui_feel + "&client_id=" + this.guiController.getClientId());	
