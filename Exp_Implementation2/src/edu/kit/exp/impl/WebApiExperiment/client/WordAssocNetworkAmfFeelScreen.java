 ...
 * @see Screen
 */
public class WordAssocNetworkAmfFeelScreen extends Screen {
	...
	public WordAssocNetworkAmfFeelScreen(String gameId, ParamObject parameter, String screenId, Long showUpTime) {
		...
		browser.loadURL(ExperimentConfiguration.wordassocnetwork_amf_feel + "&client_id=" + this.guiController.getClientId());	
